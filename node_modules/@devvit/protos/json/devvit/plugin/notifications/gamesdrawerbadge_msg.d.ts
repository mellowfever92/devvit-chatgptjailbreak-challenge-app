...
export type ShowGamesDrawerBadgeResponse = {
...
export type DismissGamesDrawerBadgeRequest = {};
/** Response from dismissing active games drawer badges */
export type DismissGamesDrawerBadgeResponse = {
...
export type GetGamesDrawerBadgeStatusRequest = {};
/** Response from getting the status of an active games drawer badge for an app */
export type GetGamesDrawerBadgeStatusResponse = {
...
//# sourceMappingURL=gamesdrawerbadge_msg.d.ts.map