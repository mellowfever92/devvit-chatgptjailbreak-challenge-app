...
import { AppConfig } from "../../../../../reddit/devvit/common/v1/app.js";
import { messageTypeRegistry } from "../../../../../typeRegistry.js";
import { webViewImmersiveModeFromJSON, webViewImmersiveModeToJSON } from "./immersive_mode.js";
...
function createBaseBridgeContext() {
    return {
        ...
        viewMode: undefined,
        signedRequestContext: undefined,
        webViewClientData: undefined,
    };
}
export const BridgeContext = {
    ...
    encode(message, writer = _m0.Writer.create()) {
        ...
        if (message.viewMode !== undefined) {
            writer.uint32(80).int32(message.viewMode);
        }
        if (message.signedRequestContext !== undefined) {
            writer.uint32(98).string(message.signedRequestContext);
        }
        if (message.webViewClientData !== undefined) {
            Struct.encode(Struct.wrap(message.webViewClientData), writer.uint32(106).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 13:
                    ...
                    message.webViewClientData = Struct.unwrap(Struct.decode(reader, reader.uint32()));
                    continue;
            }
            if ((tag & 7) === 4 || tag === 0) {
                break;
    ...
    fromJSON(object) {
        return {
            ...
            appPermissionState: isSet(object.appPermissionState)
                ...
                : undefined,
            viewMode: isSet(object.viewMode) ? webViewImmersiveModeFromJSON(object.viewMode) : undefined,
            signedRequestContext: isSet(object.signedRequestContext)
                ? globalThis.String(object.signedRequestContext)
                : undefined,
            webViewClientData: isObject(object.webViewClientData) ? object.webViewClientData : undefined,
        };
    },
    toJSON(message) {
        const obj = {};
        ...
        if (message.viewMode !== undefined) {
            obj.viewMode = webViewImmersiveModeToJSON(message.viewMode);
        }
        if (message.signedRequestContext !== undefined) {
            obj.signedRequestContext = message.signedRequestContext;
        }
        if (message.webViewClientData !== undefined) {
            obj.webViewClientData = message.webViewClientData;
        }
        return obj;
    },
    create(base) {
    ...
    fromPartial(object) {
        ...
        message.appPermissionState = (object.appPermissionState !== undefined && object.appPermissionState !== null)
            ...
            : undefined;
        message.viewMode = object.viewMode ?? undefined;
        message.signedRequestContext = object.signedRequestContext ?? undefined;
        message.webViewClientData = object.webViewClientData ?? undefined;
        return message;
    },
};
...
function createBaseWebViewClientData() {
    return { appConfig: undefined };
}
export const WebViewClientData = {
    $type: "devvit.ui.effects.web_view.v1alpha.WebViewClientData",
    encode(message, writer = _m0.Writer.create()) {
        if (message.appConfig !== undefined) {
            AppConfig.encode(message.appConfig, writer.uint32(10).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
        const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = createBaseWebViewClientData();
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
                    ...
                    message.appConfig = AppConfig.decode(reader, reader.uint32());
                    continue;
            }
            if ((tag & 7) === 4 || tag === 0) {
                break;
    ...
    fromJSON(object) {
        return { appConfig: isSet(object.appConfig) ? AppConfig.fromJSON(object.appConfig) : undefined };
    },
    toJSON(message) {
        const obj = {};
        if (message.appConfig !== undefined) {
            obj.appConfig = AppConfig.toJSON(message.appConfig);
        }
        return obj;
    },
    create(base) {
        return WebViewClientData.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseWebViewClientData();
        message.appConfig = (object.appConfig !== undefined && object.appConfig !== null)
            ? AppConfig.fromPartial(object.appConfig)
            : undefined;
        return message;
    },
};
messageTypeRegistry.set(WebViewClientData.$type, WebViewClientData);
