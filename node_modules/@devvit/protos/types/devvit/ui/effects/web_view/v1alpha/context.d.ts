...
import { WebViewImmersiveMode } from "./immersive_mode.js";
...
export interface BridgeContext {
    ...
    viewMode?: WebViewImmersiveMode | undefined;
    /** Signed `RequestContext` JWT. */
    signedRequestContext?: string | undefined;
 ...
 * client changes.
 */
export interface WebViewClientData {
...
export declare const WebViewClientData: {
    $type: "devvit.ui.effects.web_view.v1alpha.WebViewClientData";
    encode(message: WebViewClientData, writer?: _m0.Writer): _m0.Writer;
    decode(input: _m0.Reader | Uint8Array, length?: number): WebViewClientData;
    fromJSON(object: any): WebViewClientData;
    toJSON(message: WebViewClientData): unknown;
    create(base?: DeepPartial<WebViewClientData>): WebViewClientData;
    fromPartial(object: DeepPartial<WebViewClientData>): WebViewClientData;
};
