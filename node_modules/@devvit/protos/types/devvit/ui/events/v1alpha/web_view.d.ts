...
import { ConsentStatusEvent } from "../../effect_types/v1alpha/app_permission.js";
import { OrderResultEvent } from "../../effect_types/v1alpha/create_order.js";
import { FormCanceledEvent, FormSubmittedEvent } from "../../effect_types/v1alpha/show_form.js";
...
export declare const WebViewImmersiveModeChangedEvent: {
    $type: "devvit.ui.events.v1alpha.WebViewImmersiveModeChangedEvent";
    encode(message: WebViewImmersiveModeChangedEvent, writer?: _m0.Writer): _m0.Writer;
    decode(input: _m0.Reader | Uint8Array, length?: number): WebViewImmersiveModeChangedEvent;
    fromJSON(object: any): WebViewImmersiveModeChangedEvent;
    toJSON(message: WebViewImmersiveModeChangedEvent): unknown;
    create(base?: DeepPartial<WebViewImmersiveModeChangedEvent>): WebViewImmersiveModeChangedEvent;
    fromPartial(object: DeepPartial<WebViewImmersiveModeChangedEvent>): WebViewImmersiveModeChangedEvent;
};
