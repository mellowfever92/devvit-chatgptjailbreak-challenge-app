...
export class AppClientImpl {
    ...
    GetAllCategories(request, metadata) {
        const data = Empty.encode(request).finish();
        const promise = this.rpc.request(this.service, "GetAllCategories", data, metadata);
        return promise.then((data) => AppCategoryNodeListResponse.decode(_m0.Reader.create(data)));
    }
}
export const AppDefinition = {
    ...
    methods: {
        ...
        getAllCategories: {
            ...
            requestType: Empty,
            requestStream: false,
            responseType: AppCategoryNodeListResponse,
            responseStream: false,
            options: {},
        },
    },
...
export const InstallationsDefinition = {
    ...
    methods: {
        ...
        getAllWithVersionUUID: {
            ...
            requestType: GetAllWithVersionUUIDRequest,
            requestStream: false,
            responseType: MultipleInstallationsResponse,
            responseStream: false,
            options: {},
...
export class DataApiAdminClientImpl {
    ...
    UpdateOrganization(request, metadata) {
        const data = UpdateOrganizationRequest.encode(request).finish();
        const promise = this.rpc.request(this.service, "UpdateOrganization", data, metadata);
        return promise.then((data) => UpdateOrganizationResponse.decode(_m0.Reader.create(data)));
    }
...
export const DevPortalDeveloperSettingsServiceName = "devvit.dev_portal.DevPortalDeveloperSettings";
export class DevPortalDeveloperSettingsClientImpl {
    constructor(rpc, opts) {
        this.service = opts?.service || DevPortalDeveloperSettingsServiceName;
        this.rpc = rpc;
        this.GetPaymentsVerificationStatus = this.GetPaymentsVerificationStatus.bind(this);
    }
    GetPaymentsVerificationStatus(request, metadata) {
        const data = GetPaymentsVerificationStatusRequest.encode(request).finish();
        const promise = this.rpc.request(this.service, "GetPaymentsVerificationStatus", data, metadata);
        return promise.then((data) => GetPaymentsVerificationStatusResponse.decode(_m0.Reader.create(data)));
    }
}
export const DevPortalDeveloperSettingsDefinition = {
    name: "DevPortalDeveloperSettings",
    fullName: "devvit.dev_portal.DevPortalDeveloperSettings",
    methods: {
        /**
         ...
         */
        getPaymentsVerificationStatus: {
            name: "GetPaymentsVerificationStatus",
            requestType: GetPaymentsVerificationStatusRequest,
            requestStream: false,
            responseType: GetPaymentsVerificationStatusResponse,
            responseStream: false,
            options: {},
        },
    },
...
export const DeveloperAccountServiceName = "devvit.dev_portal.DeveloperAccount";
export class DeveloperAccountClientImpl {
    constructor(rpc, opts) {
        this.service = opts?.service || DeveloperAccountServiceName;
        this.rpc = rpc;
        this.RegisterUser = this.RegisterUser.bind(this);
        this.GetUserAccountInfoIfExists = this.GetUserAccountInfoIfExists.bind(this);
    }
    RegisterUser(request, metadata) {
        ...
        return promise.then((data) => DeveloperAccountInfo.decode(_m0.Reader.create(data)));
    }
    GetUserAccountInfoIfExists(request, metadata) {
        const data = Empty.encode(request).finish();
        const promise = this.rpc.request(this.service, "GetUserAccountInfoIfExists", data, metadata);
        return promise.then((data) => GetUserAccountInfoResponse.decode(_m0.Reader.create(data)));
    }
}
export const DeveloperAccountDefinition = {
    name: "DeveloperAccount",
    fullName: "devvit.dev_portal.DeveloperAccount",
    methods: {
        registerUser: {
            name: "RegisterUser",
            requestType: DeveloperAccountRegisterUserRequest,
            requestStream: false,
            responseType: DeveloperAccountInfo,
            responseStream: false,
            options: {},
        },
        getUserAccountInfoIfExists: {
            name: "GetUserAccountInfoIfExists",
            requestType: Empty,
            requestStream: false,
            responseType: GetUserAccountInfoResponse,
            responseStream: false,
            options: {},
        },
    },
