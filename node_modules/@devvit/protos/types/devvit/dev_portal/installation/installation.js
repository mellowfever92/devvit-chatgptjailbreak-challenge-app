 ...
 */
export var DeveloperPermissions;
(function (DeveloperPermissions) {
    /** NONE - No permissions granted */
    DeveloperPermissions[DeveloperPermissions["NONE"] = 0] = "NONE";
    /**
     * READ_INSTALL_LOGS - Developer can stream the installation's logs and see the installation page
     * in portal, but cannot edit the installation's settings
     */
    DeveloperPermissions[DeveloperPermissions["READ_INSTALL_LOGS"] = 1] = "READ_INSTALL_LOGS";
    DeveloperPermissions[DeveloperPermissions["UNRECOGNIZED"] = -1] = "UNRECOGNIZED";
})(DeveloperPermissions || (DeveloperPermissions = {}));
export function developerPermissionsFromJSON(object) {
    switch (object) {
        case 0:
        case "NONE":
            return DeveloperPermissions.NONE;
        case 1:
        case "READ_INSTALL_LOGS":
            return DeveloperPermissions.READ_INSTALL_LOGS;
        case -1:
        case "UNRECOGNIZED":
        default:
            return DeveloperPermissions.UNRECOGNIZED;
    }
}
export function developerPermissionsToJSON(object) {
    switch (object) {
        case DeveloperPermissions.NONE:
            return 0;
        case DeveloperPermissions.READ_INSTALL_LOGS:
            return 1;
        case DeveloperPermissions.UNRECOGNIZED:
        default:
            return -1;
    }
}
 ...
 * so they must be kept in sync
 */
export var AppInstallState;
(function (AppInstallState) {
    /** ACTIVE - Installation is active and running */
    AppInstallState[AppInstallState["ACTIVE"] = 0] = "ACTIVE";
    /** DISABLED - Installation is disabled (not deleted, just turned off) */
    AppInstallState[AppInstallState["DISABLED"] = 1] = "DISABLED";
    /** APP_UNINSTALLED - Installation has been uninstalled (soft deleted) */
    AppInstallState[AppInstallState["APP_UNINSTALLED"] = 2] = "APP_UNINSTALLED";
    AppInstallState[AppInstallState["UNRECOGNIZED"] = -1] = "UNRECOGNIZED";
})(AppInstallState || (AppInstallState = {}));
export function appInstallStateFromJSON(object) {
    switch (object) {
        case 0:
        case "ACTIVE":
            return AppInstallState.ACTIVE;
        case 1:
        case "DISABLED":
            return AppInstallState.DISABLED;
        case 2:
        case "APP_UNINSTALLED":
            return AppInstallState.APP_UNINSTALLED;
        case -1:
        case "UNRECOGNIZED":
        default:
            return AppInstallState.UNRECOGNIZED;
    }
}
export function appInstallStateToJSON(object) {
    switch (object) {
        case AppInstallState.ACTIVE:
            return 0;
        case AppInstallState.DISABLED:
            return 1;
        case AppInstallState.APP_UNINSTALLED:
            return 2;
        case AppInstallState.UNRECOGNIZED:
        default:
            return -1;
    }
}
...
function createBaseInstallationUpdateRequest() {
    return {
        ...
        upgradeStrategyConfig: undefined,
        developerPermissions: undefined,
...
export const InstallationUpdateRequest = {
    ...
    encode(message, writer = _m0.Writer.create()) {
        ...
        if (message.developerPermissions !== undefined) {
            writer.uint32(56).int32(message.developerPermissions);
        }
        if (message.appInstallState !== undefined) {
            writer.uint32(64).int32(message.appInstallState);
        }
        return writer;
    },
    decode(input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 7:
                    ...
                    message.developerPermissions = reader.int32();
                    continue;
                case 8:
                    if (tag !== 64) {
                        break;
                    }
                    message.appInstallState = reader.int32();
                    continue;
            }
            if ((tag & 7) === 4 || tag === 0) {
                break;
    ...
    fromJSON(object) {
        return {
            ...
            upgradeStrategy: isSet(object.upgradeStrategy)
                ...
                : undefined,
            upgradeStrategyConfig: isObject(object.upgradeStrategyConfig) ? object.upgradeStrategyConfig : undefined,
            developerPermissions: isSet(object.developerPermissions)
                ? developerPermissionsFromJSON(object.developerPermissions)
                : undefined,
            appInstallState: isSet(object.appInstallState) ? appInstallStateFromJSON(object.appInstallState) : undefined,
        };
    },
    toJSON(message) {
        const obj = {};
        ...
        if (message.developerPermissions !== undefined) {
            obj.developerPermissions = developerPermissionsToJSON(message.developerPermissions);
        }
        if (message.appInstallState !== undefined) {
            obj.appInstallState = appInstallStateToJSON(message.appInstallState);
        }
        return obj;
    },
    create(base) {
    ...
    fromPartial(object) {
        ...
        message.upgradeStrategy = (object.upgradeStrategy !== undefined && object.upgradeStrategy !== null)
            ...
            : undefined;
        message.upgradeStrategyConfig = object.upgradeStrategyConfig ?? undefined;
        message.developerPermissions = object.developerPermissions ?? undefined;
        message.appInstallState = object.appInstallState ?? undefined;
        return message;
    },
};
...
function createBaseGetAllWithInstallLocationRequest() {
    return { type: 0, location: "", take: undefined, skip: undefined };
}
...
function createBaseGetAllWithInstallerRequest() {
    return { installedBy: "", take: undefined, skip: undefined };
}
export const GetAllWithInstallerRequest = {
    ...
    fromJSON(object) {
        return {
            installedBy: isSet(object.installedBy) ? globalThis.String(object.installedBy) : "",
            take: isSet(object.take) ? globalThis.Number(object.take) : undefined,
            skip: isSet(object.skip) ? globalThis.Number(object.skip) : undefined,
        };
    },
...
function createBaseGetAllWithVersionUUIDRequest() {
    return { id: "", take: undefined, skip: undefined };
}
export const GetAllWithVersionUUIDRequest = {
    ...
    decode(input, length) {
        const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = createBaseGetAllWithVersionUUIDRequest();
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
    ...
    create(base) {
        return GetAllWithVersionUUIDRequest.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseGetAllWithVersionUUIDRequest();
        message.id = object.id ?? "";
...
messageTypeRegistry.set(GetAllWithVersionUUIDRequest.$type, GetAllWithVersionUUIDRequest);
...
export const InstallationInfo = {
    ...
    encode(message, writer = _m0.Writer.create()) {
        ...
        if (message.developerPermissions !== 0) {
            writer.uint32(80).int32(message.developerPermissions);
        }
        if (message.appInstallState !== 0) {
            writer.uint32(88).int32(message.appInstallState);
        }
        return writer;
    },
    decode(input, length) {
    ...
    fromJSON(object) {
        return {
            ...
            developerPermissions: isSet(object.developerPermissions)
                ? developerPermissionsFromJSON(object.developerPermissions)
                : 0,
            appInstallState: isSet(object.appInstallState) ? appInstallStateFromJSON(object.appInstallState) : 0,
        };
    },
    toJSON(message) {
        const obj = {};
    ...
    fromPartial(object) {
        ...
        message.location = (object.location !== undefined && object.location !== null)
            ...
            : undefined;
        message.developerPermissions = object.developerPermissions ?? 0;
        message.appInstallState = object.appInstallState ?? 0;
        return message;
    },
};
...
export const InstallationLocationInfo = {
    ...
    fromJSON(object) {
        return {
            ...
            isUnavailable: isSet(object.isUnavailable) ? globalThis.Boolean(object.isUnavailable) : false,
        };
    },
    toJSON(message) {
        const obj = {};
    ...
    fromJSON(object) {
        return {
            events: globalThis.Array.isArray(object?.events)
                ? object.events.map((e) => InstallationHistoryEvent.fromJSON(e))
                : [],
