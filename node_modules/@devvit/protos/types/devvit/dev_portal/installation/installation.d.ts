 ...
 */
export declare enum DeveloperPermissions {
...
export declare function developerPermissionsFromJSON(object: any): DeveloperPermissions;
export declare function developerPermissionsToJSON(object: DeveloperPermissions): number;
/**
 * State of an app installation
 * This enum maps 1-to-1 to its Prisma equivalent in prisma/schema.prisma,
 * so they must be kept in sync
 */
export declare enum AppInstallState {
...
export declare function appInstallStateFromJSON(object: any): AppInstallState;
export declare function appInstallStateToJSON(object: AppInstallState): number;
...
export interface InstallationUpdateRequest {
    ...
    developerPermissions?: DeveloperPermissions | undefined;
    /** The new state of the installation. */
    appInstallState?: AppInstallState | undefined;
}
...
export interface GetAllWithVersionUUIDRequest {
...
export declare const GetAllWithVersionUUIDRequest: {
    ...
    create(base?: DeepPartial<GetAllWithVersionUUIDRequest>): GetAllWithVersionUUIDRequest;
    fromPartial(object: DeepPartial<GetAllWithVersionUUIDRequest>): GetAllWithVersionUUIDRequest;
};
