...
export interface AppTwirp<T extends TwirpContext = TwirpContext> {
    ...
    Disable(ctx: T, request: DisableAppRequest): Promise<Empty>;
    Enable(ctx: T, request: EnableAppRequest): Promise<Empty>;
    ...
    GetAllCategories(ctx: T, request: Empty): Promise<AppCategoryNodeListResponse>;
}
...
export interface AppVersionTwirp<T extends TwirpContext = TwirpContext> {
    ...
    GetProductsByAppVersionId(ctx: T, request: UUID): Promise<ProductList>;
}
export declare enum AppVersionMethod {
    ...
    GetProductsByAppVersionId = "GetProductsByAppVersionId"
}
...
export interface InstallationsTwirp<T extends TwirpContext = TwirpContext> {
    ...
    GetAllWithVersionUUID(ctx: T, request: GetAllWithVersionUUIDRequest): Promise<MultipleInstallationsResponse>;
    GetAllWithApp(ctx: T, request: GetAllWithAppRequest): Promise<GetAllWithAppResponse>;
...
export interface DataApiAdminTwirp<T extends TwirpContext = TwirpContext> {
    ...
    UpdateOrganization(ctx: T, request: UpdateOrganizationRequest): Promise<UpdateOrganizationResponse>;
    GetAuditLogEvents(ctx: T, request: GetAuditLogEventsRequest): Promise<GetAuditLogEventsResponse>;
    AddUsersToOrg(ctx: T, request: AddUsersToOrgRequest): Promise<AddUsersToOrgResponse>;
    GetUsersByOrgId(ctx: T, request: GetUsersByOrgIdRequest): Promise<GetUsersByOrgIdResponse>;
    GetUserById(ctx: T, request: GetUserByIdRequest): Promise<GetUserByIdResponse>;
    DeleteUser(ctx: T, request: DeleteUserRequest): Promise<DeleteUserResponse>;
}
...
export interface DevPortalDeveloperSettingsTwirp<T extends TwirpContext = TwirpContext> {
    GetPaymentsVerificationStatus(ctx: T, request: GetPaymentsVerificationStatusRequest): Promise<GetPaymentsVerificationStatusResponse>;
}
export declare enum DevPortalDeveloperSettingsMethod {
    GetPaymentsVerificationStatus = "GetPaymentsVerificationStatus"
}
export declare const DevPortalDeveloperSettingsMethodList: DevPortalDeveloperSettingsMethod[];
export declare function createDevPortalDeveloperSettingsServer<T extends TwirpContext = TwirpContext>(service: DevPortalDeveloperSettingsTwirp<T>): TwirpServer<DevPortalDeveloperSettingsTwirp<TwirpContext<import("http").IncomingMessage, import("http").ServerResponse<import("http").IncomingMessage>>>, T>;
export interface DevPortalAppPublishRequestTwirp<T extends TwirpContext = TwirpContext> {
    Submit(ctx: T, request: AppPRCreateRequest): Promise<UUID>;
    Update(ctx: T, request: AppPRUpdateRequest): Promise<Empty>;
    Get(ctx: T, request: AppPRGetRequest): Promise<FullPublishRequestInfo>;
    FindMany(ctx: T, request: AppPRFindManyRequest): Promise<MultiplePublishRequestInfos>;
    SetReviewDecision(ctx: T, request: AppPRSetReviewDecisionRequest): Promise<UUID>;
    RemoveReview(ctx: T, request: UUID): Promise<Empty>;
    AddNote(ctx: T, request: AppPRAddNoteRequest): Promise<UUID>;
    UpdateNote(ctx: T, request: AppPRUpdateNoteRequest): Promise<Empty>;
    RemoveNote(ctx: T, request: UUID): Promise<Empty>;
}
export declare enum DevPortalAppPublishRequestMethod {
    Submit = "Submit",
    Update = "Update",
    Get = "Get",
    FindMany = "FindMany",
...
export declare const DevPortalAppPublishRequestMethodList: DevPortalAppPublishRequestMethod[];
export declare function createDevPortalAppPublishRequestServer<T extends TwirpContext = TwirpContext>(service: DevPortalAppPublishRequestTwirp<T>): TwirpServer<DevPortalAppPublishRequestTwirp<TwirpContext<import("http").IncomingMessage, import("http").ServerResponse<import("http").IncomingMessage>>>, T>;
export interface DeveloperAccountTwirp<T extends TwirpContext = TwirpContext> {
    RegisterUser(ctx: T, request: DeveloperAccountRegisterUserRequest): Promise<DeveloperAccountInfo>;
    GetUserAccountInfoIfExists(ctx: T, request: Empty): Promise<GetUserAccountInfoResponse>;
}
export declare enum DeveloperAccountMethod {
    RegisterUser = "RegisterUser",
    GetUserAccountInfoIfExists = "GetUserAccountInfoIfExists"
}
export declare const DeveloperAccountMethodList: DeveloperAccountMethod[];
export declare function createDeveloperAccountServer<T extends TwirpContext = TwirpContext>(service: DeveloperAccountTwirp<T>): TwirpServer<DeveloperAccountTwirp<TwirpContext<import("http").IncomingMessage, import("http").ServerResponse<import("http").IncomingMessage>>>, T>;
