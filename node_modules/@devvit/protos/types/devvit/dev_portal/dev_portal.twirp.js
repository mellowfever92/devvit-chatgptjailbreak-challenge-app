...
(function (AppMethod) {
    ...
    AppMethod["Disable"] = "Disable";
    AppMethod["Enable"] = "Enable";
    AppMethod["Exists"] = "Exists";
    AppMethod["AppAccountExists"] = "AppAccountExists";
    AppMethod["CreateAppAccount"] = "CreateAppAccount";
    AppMethod["RecoverAppAccount"] = "RecoverAppAccount";
    AppMethod["GetAllCategories"] = "GetAllCategories";
})(AppMethod || (AppMethod = {}));
export const AppMethodList = [
    ...
    AppMethod.RecoverAppAccount,
    AppMethod.GetAllCategories,
];
...
function matchAppRoute(method, events) {
    switch (method) {
        ...
        case 'Disable':
            return async (ctx, service, data, interceptors) => {
                ctx = { ...ctx, methodName: 'Disable' };
                await events.onMatch(ctx);
                return handleAppDisableRequest(ctx, service, data, interceptors);
            };
        case 'Enable':
            return async (ctx, service, data, interceptors) => {
                ctx = { ...ctx, methodName: 'Enable' };
                await events.onMatch(ctx);
                return handleAppEnableRequest(ctx, service, data, interceptors);
            };
        case 'Exists':
            return async (ctx, service, data, interceptors) => {
        ...
        case 'RecoverAppAccount':
            return async (ctx, service, data, interceptors) => {
                ctx = { ...ctx, methodName: 'RecoverAppAccount' };
                await events.onMatch(ctx);
                return handleAppRecoverAppAccountRequest(ctx, service, data, interceptors);
            };
        case 'GetAllCategories':
            return async (ctx, service, data, interceptors) => {
                ctx = { ...ctx, methodName: 'GetAllCategories' };
                await events.onMatch(ctx);
                return handleAppGetAllCategoriesRequest(ctx, service, data, interceptors);
            };
        default:
            events.onNotFound();
...
function handleAppDisableRequest(ctx, service, data, interceptors) {
    switch (ctx.contentType) {
        case TwirpContentType.JSON:
            return handleAppDisableJSON(ctx, service, data, interceptors);
        case TwirpContentType.Protobuf:
            return handleAppDisableProtobuf(ctx, service, data, interceptors);
        default:
            const msg = 'unexpected Content-Type';
            throw new TwirpError(TwirpErrorCode.BadRoute, msg);
    }
}
function handleAppEnableRequest(ctx, service, data, interceptors) {
    switch (ctx.contentType) {
        case TwirpContentType.JSON:
            return handleAppEnableJSON(ctx, service, data, interceptors);
        case TwirpContentType.Protobuf:
            return handleAppEnableProtobuf(ctx, service, data, interceptors);
        default:
            const msg = 'unexpected Content-Type';
            throw new TwirpError(TwirpErrorCode.BadRoute, msg);
    }
...
function handleAppRecoverAppAccountRequest(ctx, service, data, interceptors) {
    switch (ctx.contentType) {
        case TwirpContentType.JSON:
            return handleAppRecoverAppAccountJSON(ctx, service, data, interceptors);
        case TwirpContentType.Protobuf:
            return handleAppRecoverAppAccountProtobuf(ctx, service, data, interceptors);
        default:
            const msg = 'unexpected Content-Type';
            throw new TwirpError(TwirpErrorCode.BadRoute, msg);
    }
}
function handleAppGetAllCategoriesRequest(ctx, service, data, interceptors) {
    switch (ctx.contentType) {
        case TwirpContentType.JSON:
            return handleAppGetAllCategoriesJSON(ctx, service, data, interceptors);
        case TwirpContentType.Protobuf:
            return handleAppGetAllCategoriesProtobuf(ctx, service, data, interceptors);
        default:
            const msg = 'unexpected Content-Type';
            throw new TwirpError(TwirpErrorCode.BadRoute, msg);
    }
...
async function handleAppDisableJSON(ctx, service, data, interceptors) {
    let request;
    let response;
    try {
        const body = JSON.parse(data.toString() || '{}');
        request = DisableAppRequest.fromJSON(body);
    }
    catch (e) {
        if (e instanceof Error) {
            const msg = 'the json request could not be decoded';
    ...
    if (interceptors && interceptors.length > 0) {
        const interceptor = chainInterceptors(...interceptors);
        response = await interceptor(ctx, request, (ctx, inputReq) => {
            return service.Disable(ctx, inputReq);
        });
    }
    else {
        response = await service.Disable(ctx, request);
    }
    return JSON.stringify(Empty.toJSON(response));
}
async function handleAppEnableJSON(ctx, service, data, interceptors) {
    let request;
    let response;
    try {
        const body = JSON.parse(data.toString() || '{}');
        request = EnableAppRequest.fromJSON(body);
    }
    catch (e) {
        if (e instanceof Error) {
            const msg = 'the json request could not be decoded';
    ...
    if (interceptors && interceptors.length > 0) {
        const interceptor = chainInterceptors(...interceptors);
        response = await interceptor(ctx, request, (ctx, inputReq) => {
            return service.Enable(ctx, inputReq);
        });
    }
    else {
        response = await service.Enable(ctx, request);
    }
    return JSON.stringify(Empty.toJSON(response));
}
...
async function handleAppRecoverAppAccountJSON(ctx, service, data, interceptors) {
    let request;
    let response;
    try {
        const body = JSON.parse(data.toString() || '{}');
        request = RecoverAppAccountRequest.fromJSON(body);
    }
    catch (e) {
        if (e instanceof Error) {
            const msg = 'the json request could not be decoded';
    ...
    if (interceptors && interceptors.length > 0) {
        const interceptor = chainInterceptors(...interceptors);
        response = await interceptor(ctx, request, (ctx, inputReq) => {
            return service.RecoverAppAccount(ctx, inputReq);
        });
    }
    else {
        response = await service.RecoverAppAccount(ctx, request);
    }
    return JSON.stringify(AppInfo.toJSON(response));
}
async function handleAppGetAllCategoriesJSON(ctx, service, data, interceptors) {
    let request;
    let response;
    try {
        const body = JSON.parse(data.toString() || '{}');
    ...
    if (interceptors && interceptors.length > 0) {
        const interceptor = chainInterceptors(...interceptors);
        response = await interceptor(ctx, request, (ctx, inputReq) => {
            return service.GetAllCategories(ctx, inputReq);
        });
    }
    else {
        response = await service.GetAllCategories(ctx, request);
    }
    return JSON.stringify(AppCategoryNodeListResponse.toJSON(response));
}
...
async function handleAppDisableProtobuf(ctx, service, data, interceptors) {
    let request;
    let response;
    try {
        request = DisableAppRequest.decode(data);
    }
    catch (e) {
        if (e instanceof Error) {
            const msg = 'the protobuf request could not be decoded';
...
async function handleAppEnableProtobuf(ctx, service, data, interceptors) {
    let request;
    let response;
    try {
        request = EnableAppRequest.decode(data);
    }
    catch (e) {
        if (e instanceof Error) {
            const msg = 'the protobuf request could not be decoded';
...
async function handleAppRecoverAppAccountProtobuf(ctx, service, data, interceptors) {
    let request;
    let response;
    try {
        request = RecoverAppAccountRequest.decode(data);
    }
    catch (e) {
        if (e instanceof Error) {
            const msg = 'the protobuf request could not be decoded';
...
async function handleAppGetAllCategoriesProtobuf(ctx, service, data, interceptors) {
    let request;
    let response;
    try {
    ...
    return Buffer.from(AppCategoryNodeListResponse.encode(response).finish());
}
...
(function (AppVersionMethod) {
    ...
    AppVersionMethod["GetProductsByAppVersionId"] = "GetProductsByAppVersionId";
...
export const AppVersionMethodList = [
    ...
    AppVersionMethod.GetProductsByAppVersionId,
];
...
function matchAppVersionRoute(method, events) {
    switch (method) {
        ...
        case 'GetProductsByAppVersionId':
            return async (ctx, service, data, interceptors) => {
                ctx = { ...ctx, methodName: 'GetProductsByAppVersionId' };
                await events.onMatch(ctx);
                return handleAppVersionGetProductsByAppVersionIdRequest(ctx, service, data, interceptors);
            };
        default:
            events.onNotFound();
            const msg = `no handler found`;
...
function handleAppVersionGetProductsByAppVersionIdRequest(ctx, service, data, interceptors) {
    switch (ctx.contentType) {
        case TwirpContentType.JSON:
            return handleAppVersionGetProductsByAppVersionIdJSON(ctx, service, data, interceptors);
        case TwirpContentType.Protobuf:
            return handleAppVersionGetProductsByAppVersionIdProtobuf(ctx, service, data, interceptors);
        default:
            const msg = 'unexpected Content-Type';
            throw new TwirpError(TwirpErrorCode.BadRoute, msg);
    }
...
async function handleAppVersionGetProductsByAppVersionIdJSON(ctx, service, data, interceptors) {
    let request;
    let response;
    try {
        const body = JSON.parse(data.toString() || '{}');
    ...
    if (interceptors && interceptors.length > 0) {
        const interceptor = chainInterceptors(...interceptors);
        response = await interceptor(ctx, request, (ctx, inputReq) => {
            return service.GetProductsByAppVersionId(ctx, inputReq);
        });
    }
    else {
        response = await service.GetProductsByAppVersionId(ctx, request);
    }
    return JSON.stringify(ProductList.toJSON(response));
}
...
async function handleAppVersionGetProductsByAppVersionIdProtobuf(ctx, service, data, interceptors) {
    let request;
    let response;
    try {
        request = UUID.decode(data);
    ...
    return Buffer.from(ProductList.encode(response).finish());
}
...
async function handleInstallationsGetAllWithVersionUUIDJSON(ctx, service, data, interceptors) {
    ...
    try {
        const body = JSON.parse(data.toString() || '{}');
        request = GetAllWithVersionUUIDRequest.fromJSON(body);
    }
    catch (e) {
        if (e instanceof Error) {
            const msg = 'the json request could not be decoded';
...
async function handleInstallationsGetAllWithAppJSON(ctx, service, data, interceptors) {
    ...
    try {
        const body = JSON.parse(data.toString() || '{}');
        request = GetAllWithAppRequest.fromJSON(body);
    }
    catch (e) {
        if (e instanceof Error) {
            const msg = 'the json request could not be decoded';
...
async function handleInstallationsGetAllWithVersionUUIDProtobuf(ctx, service, data, interceptors) {
    ...
    let response;
    try {
        request = GetAllWithVersionUUIDRequest.decode(data);
    }
    catch (e) {
        if (e instanceof Error) {
            const msg = 'the protobuf request could not be decoded';
...
async function handleInstallationsGetAllWithAppProtobuf(ctx, service, data, interceptors) {
    ...
    let response;
    try {
        request = GetAllWithAppRequest.decode(data);
    }
    catch (e) {
        if (e instanceof Error) {
            const msg = 'the protobuf request could not be decoded';
...
(function (DataApiAdminMethod) {
    ...
    DataApiAdminMethod["UpdateOrganization"] = "UpdateOrganization";
    DataApiAdminMethod["GetAuditLogEvents"] = "GetAuditLogEvents";
    DataApiAdminMethod["AddUsersToOrg"] = "AddUsersToOrg";
...
export const DataApiAdminMethodList = [
    ...
    DataApiAdminMethod.UpdateOrganization,
    DataApiAdminMethod.GetAuditLogEvents,
    DataApiAdminMethod.AddUsersToOrg,
...
function matchDataApiAdminRoute(method, events) {
    switch (method) {
        ...
        case 'UpdateOrganization':
            return async (ctx, service, data, interceptors) => {
                ctx = { ...ctx, methodName: 'UpdateOrganization' };
                await events.onMatch(ctx);
                return handleDataApiAdminUpdateOrganizationRequest(ctx, service, data, interceptors);
            };
        ...
        case 'AddUsersToOrg':
            return async (ctx, service, data, interceptors) => {
                ctx = { ...ctx, methodName: 'AddUsersToOrg' };
                await events.onMatch(ctx);
                return handleDataApiAdminAddUsersToOrgRequest(ctx, service, data, interceptors);
            };
        case 'GetUsersByOrgId':
            return async (ctx, service, data, interceptors) => {
                ctx = { ...ctx, methodName: 'GetUsersByOrgId' };
                await events.onMatch(ctx);
                return handleDataApiAdminGetUsersByOrgIdRequest(ctx, service, data, interceptors);
            };
        case 'GetUserById':
            return async (ctx, service, data, interceptors) => {
                ctx = { ...ctx, methodName: 'GetUserById' };
                await events.onMatch(ctx);
                return handleDataApiAdminGetUserByIdRequest(ctx, service, data, interceptors);
            };
        case 'DeleteUser':
            return async (ctx, service, data, interceptors) => {
                ctx = { ...ctx, methodName: 'DeleteUser' };
                await events.onMatch(ctx);
...
function handleDataApiAdminUpdateOrganizationRequest(ctx, service, data, interceptors) {
    switch (ctx.contentType) {
        case TwirpContentType.JSON:
            return handleDataApiAdminUpdateOrganizationJSON(ctx, service, data, interceptors);
        case TwirpContentType.Protobuf:
            return handleDataApiAdminUpdateOrganizationProtobuf(ctx, service, data, interceptors);
        default:
            const msg = 'unexpected Content-Type';
            throw new TwirpError(TwirpErrorCode.BadRoute, msg);
    }
...
function handleDataApiAdminAddUsersToOrgRequest(ctx, service, data, interceptors) {
    switch (ctx.contentType) {
        case TwirpContentType.JSON:
            return handleDataApiAdminAddUsersToOrgJSON(ctx, service, data, interceptors);
        case TwirpContentType.Protobuf:
            return handleDataApiAdminAddUsersToOrgProtobuf(ctx, service, data, interceptors);
        default:
            const msg = 'unexpected Content-Type';
            throw new TwirpError(TwirpErrorCode.BadRoute, msg);
    }
}
function handleDataApiAdminGetUsersByOrgIdRequest(ctx, service, data, interceptors) {
    switch (ctx.contentType) {
        case TwirpContentType.JSON:
            return handleDataApiAdminGetUsersByOrgIdJSON(ctx, service, data, interceptors);
        case TwirpContentType.Protobuf:
            return handleDataApiAdminGetUsersByOrgIdProtobuf(ctx, service, data, interceptors);
        default:
            const msg = 'unexpected Content-Type';
            throw new TwirpError(TwirpErrorCode.BadRoute, msg);
    }
}
function handleDataApiAdminGetUserByIdRequest(ctx, service, data, interceptors) {
    switch (ctx.contentType) {
        case TwirpContentType.JSON:
            return handleDataApiAdminGetUserByIdJSON(ctx, service, data, interceptors);
        case TwirpContentType.Protobuf:
            return handleDataApiAdminGetUserByIdProtobuf(ctx, service, data, interceptors);
        default:
            const msg = 'unexpected Content-Type';
            throw new TwirpError(TwirpErrorCode.BadRoute, msg);
    }
}
function handleDataApiAdminDeleteUserRequest(ctx, service, data, interceptors) {
    switch (ctx.contentType) {
        case TwirpContentType.JSON:
            return handleDataApiAdminDeleteUserJSON(ctx, service, data, interceptors);
        case TwirpContentType.Protobuf:
            return handleDataApiAdminDeleteUserProtobuf(ctx, service, data, interceptors);
        default:
            const msg = 'unexpected Content-Type';
            throw new TwirpError(TwirpErrorCode.BadRoute, msg);
    }
...
async function handleDataApiAdminUpdateOrganizationJSON(ctx, service, data, interceptors) {
    let request;
    let response;
    try {
        const body = JSON.parse(data.toString() || '{}');
        request = UpdateOrganizationRequest.fromJSON(body);
    }
    catch (e) {
        if (e instanceof Error) {
            const msg = 'the json request could not be decoded';
    ...
    if (interceptors && interceptors.length > 0) {
        const interceptor = chainInterceptors(...interceptors);
        response = await interceptor(ctx, request, (ctx, inputReq) => {
            return service.UpdateOrganization(ctx, inputReq);
        });
    }
    else {
        response = await service.UpdateOrganization(ctx, request);
    }
    return JSON.stringify(UpdateOrganizationResponse.toJSON(response));
}
...
async function handleDataApiAdminAddUsersToOrgJSON(ctx, service, data, interceptors) {
    let request;
    let response;
    try {
        const body = JSON.parse(data.toString() || '{}');
        request = AddUsersToOrgRequest.fromJSON(body);
    }
    catch (e) {
        if (e instanceof Error) {
            const msg = 'the json request could not be decoded';
    ...
    if (interceptors && interceptors.length > 0) {
        const interceptor = chainInterceptors(...interceptors);
        response = await interceptor(ctx, request, (ctx, inputReq) => {
            return service.AddUsersToOrg(ctx, inputReq);
        });
    }
    else {
        response = await service.AddUsersToOrg(ctx, request);
    }
    return JSON.stringify(AddUsersToOrgResponse.toJSON(response));
}
async function handleDataApiAdminGetUsersByOrgIdJSON(ctx, service, data, interceptors) {
    let request;
    let response;
    try {
        const body = JSON.parse(data.toString() || '{}');
        request = GetUsersByOrgIdRequest.fromJSON(body);
    }
    catch (e) {
        if (e instanceof Error) {
            const msg = 'the json request could not be decoded';
    ...
    if (interceptors && interceptors.length > 0) {
        const interceptor = chainInterceptors(...interceptors);
        response = await interceptor(ctx, request, (ctx, inputReq) => {
            return service.GetUsersByOrgId(ctx, inputReq);
        });
    }
    else {
        response = await service.GetUsersByOrgId(ctx, request);
    }
    return JSON.stringify(GetUsersByOrgIdResponse.toJSON(response));
}
async function handleDataApiAdminGetUserByIdJSON(ctx, service, data, interceptors) {
    let request;
    let response;
    try {
        const body = JSON.parse(data.toString() || '{}');
        request = GetUserByIdRequest.fromJSON(body);
    }
    catch (e) {
        if (e instanceof Error) {
            const msg = 'the json request could not be decoded';
    ...
    return JSON.stringify(GetUserByIdResponse.toJSON(response));
}
async function handleDataApiAdminDeleteUserJSON(ctx, service, data, interceptors) {
    let request;
    let response;
    try {
        const body = JSON.parse(data.toString() || '{}');
        request = DeleteUserRequest.fromJSON(body);
    }
    catch (e) {
        if (e instanceof Error) {
            const msg = 'the json request could not be decoded';
    ...
    if (interceptors && interceptors.length > 0) {
        const interceptor = chainInterceptors(...interceptors);
        response = await interceptor(ctx, request, (ctx, inputReq) => {
            return service.DeleteUser(ctx, inputReq);
        });
    }
    else {
        response = await service.DeleteUser(ctx, request);
    }
...
async function handleDataApiAdminUpdateOrganizationProtobuf(ctx, service, data, interceptors) {
    let request;
    let response;
    try {
        request = UpdateOrganizationRequest.decode(data);
    }
    catch (e) {
        if (e instanceof Error) {
            const msg = 'the protobuf request could not be decoded';
    ...
    return Buffer.from(UpdateOrganizationResponse.encode(response).finish());
}
...
async function handleDataApiAdminAddUsersToOrgProtobuf(ctx, service, data, interceptors) {
    let request;
    let response;
    try {
        request = AddUsersToOrgRequest.decode(data);
    }
    catch (e) {
        if (e instanceof Error) {
            const msg = 'the protobuf request could not be decoded';
    ...
    return Buffer.from(AddUsersToOrgResponse.encode(response).finish());
}
async function handleDataApiAdminGetUsersByOrgIdProtobuf(ctx, service, data, interceptors) {
    let request;
    let response;
    try {
        request = GetUsersByOrgIdRequest.decode(data);
    }
    catch (e) {
        if (e instanceof Error) {
            const msg = 'the protobuf request could not be decoded';
    ...
    return Buffer.from(GetUsersByOrgIdResponse.encode(response).finish());
}
async function handleDataApiAdminGetUserByIdProtobuf(ctx, service, data, interceptors) {
    let request;
    let response;
    try {
        request = GetUserByIdRequest.decode(data);
    }
    catch (e) {
        if (e instanceof Error) {
            const msg = 'the protobuf request could not be decoded';
    ...
    return Buffer.from(GetUserByIdResponse.encode(response).finish());
}
async function handleDataApiAdminDeleteUserProtobuf(ctx, service, data, interceptors) {
    let request;
    let response;
    try {
        request = DeleteUserRequest.decode(data);
    }
    catch (e) {
        if (e instanceof Error) {
            const msg = 'the protobuf request could not be decoded';
...
(function (DevPortalAppPublishRequestMethod) {
    ...
    DevPortalAppPublishRequestMethod["FindMany"] = "FindMany";
    DevPortalAppPublishRequestMethod["SetReviewDecision"] = "SetReviewDecision";
...
export const DevPortalAppPublishRequestMethodList = [
    ...
    DevPortalAppPublishRequestMethod.FindMany,
    DevPortalAppPublishRequestMethod.SetReviewDecision,
...
function matchDevPortalAppPublishRequestRoute(method, events) {
    switch (method) {
        ...
        case 'FindMany':
            return async (ctx, service, data, interceptors) => {
                ctx = { ...ctx, methodName: 'FindMany' };
                await events.onMatch(ctx);
                return handleDevPortalAppPublishRequestFindManyRequest(ctx, service, data, interceptors);
            };
        case 'SetReviewDecision':
            return async (ctx, service, data, interceptors) => {
                ctx = { ...ctx, methodName: 'SetReviewDecision' };
                await events.onMatch(ctx);
                return handleDevPortalAppPublishRequestSetReviewDecisionRequest(ctx, service, data, interceptors);
            };
        case 'RemoveReview':
            return async (ctx, service, data, interceptors) => {
...
function handleDevPortalAppPublishRequestFindManyRequest(ctx, service, data, interceptors) {
    switch (ctx.contentType) {
        case TwirpContentType.JSON:
            return handleDevPortalAppPublishRequestFindManyJSON(ctx, service, data, interceptors);
        case TwirpContentType.Protobuf:
            return handleDevPortalAppPublishRequestFindManyProtobuf(ctx, service, data, interceptors);
        default:
            const msg = 'unexpected Content-Type';
            throw new TwirpError(TwirpErrorCode.BadRoute, msg);
    }
}
function handleDevPortalAppPublishRequestSetReviewDecisionRequest(ctx, service, data, interceptors) {
    switch (ctx.contentType) {
        case TwirpContentType.JSON:
            return handleDevPortalAppPublishRequestSetReviewDecisionJSON(ctx, service, data, interceptors);
        case TwirpContentType.Protobuf:
            return handleDevPortalAppPublishRequestSetReviewDecisionProtobuf(ctx, service, data, interceptors);
        default:
            const msg = 'unexpected Content-Type';
            throw new TwirpError(TwirpErrorCode.BadRoute, msg);
    }
...
async function handleDevPortalAppPublishRequestFindManyJSON(ctx, service, data, interceptors) {
    let request;
    let response;
    try {
        const body = JSON.parse(data.toString() || '{}');
        request = AppPRFindManyRequest.fromJSON(body);
    }
    catch (e) {
        if (e instanceof Error) {
            const msg = 'the json request could not be decoded';
    ...
    if (interceptors && interceptors.length > 0) {
        const interceptor = chainInterceptors(...interceptors);
        response = await interceptor(ctx, request, (ctx, inputReq) => {
            return service.FindMany(ctx, inputReq);
        });
    }
    else {
        response = await service.FindMany(ctx, request);
    }
    return JSON.stringify(MultiplePublishRequestInfos.toJSON(response));
}
async function handleDevPortalAppPublishRequestSetReviewDecisionJSON(ctx, service, data, interceptors) {
    let request;
    let response;
    try {
        const body = JSON.parse(data.toString() || '{}');
        request = AppPRSetReviewDecisionRequest.fromJSON(body);
    }
    catch (e) {
        if (e instanceof Error) {
            const msg = 'the json request could not be decoded';
    ...
    if (interceptors && interceptors.length > 0) {
        const interceptor = chainInterceptors(...interceptors);
        response = await interceptor(ctx, request, (ctx, inputReq) => {
            return service.SetReviewDecision(ctx, inputReq);
        });
    }
    else {
        response = await service.SetReviewDecision(ctx, request);
    }
    return JSON.stringify(UUID.toJSON(response));
}
...
async function handleDevPortalAppPublishRequestFindManyProtobuf(ctx, service, data, interceptors) {
    let request;
    let response;
    try {
        request = AppPRFindManyRequest.decode(data);
    }
    catch (e) {
        if (e instanceof Error) {
            const msg = 'the protobuf request could not be decoded';
...
async function handleDevPortalAppPublishRequestSetReviewDecisionProtobuf(ctx, service, data, interceptors) {
    let request;
    let response;
    try {
        request = AppPRSetReviewDecisionRequest.decode(data);
    }
    catch (e) {
        if (e instanceof Error) {
            const msg = 'the protobuf request could not be decoded';
