...
export interface AppClient {
    ...
    GetAllCategories(request: Empty): Promise<AppCategoryNodeListResponse>;
}
...
export interface InstallationsClient {
    ...
    GetAllWithVersionUUID(request: GetAllWithVersionUUIDRequest): Promise<MultipleInstallationsResponse>;
...
export interface DevPortalDeveloperSettingsClient {
    GetPaymentsVerificationStatus(request: GetPaymentsVerificationStatusRequest): Promise<GetPaymentsVerificationStatusResponse>;
}
export declare class DevPortalDeveloperSettingsClientJSON implements DevPortalDeveloperSettingsClient {
    private readonly rpc;
    constructor(rpc: Rpc);
    GetPaymentsVerificationStatus(request: GetPaymentsVerificationStatusRequest): Promise<GetPaymentsVerificationStatusResponse>;
}
export declare class DevPortalDeveloperSettingsClientProtobuf implements DevPortalDeveloperSettingsClient {
    private readonly rpc;
    constructor(rpc: Rpc);
    GetPaymentsVerificationStatus(request: GetPaymentsVerificationStatusRequest): Promise<GetPaymentsVerificationStatusResponse>;
}
...
export interface DeveloperAccountClient {
    RegisterUser(request: DeveloperAccountRegisterUserRequest): Promise<DeveloperAccountInfo>;
    GetUserAccountInfoIfExists(request: Empty): Promise<GetUserAccountInfoResponse>;
}
export declare class DeveloperAccountClientJSON implements DeveloperAccountClient {
    private readonly rpc;
    constructor(rpc: Rpc);
    RegisterUser(request: DeveloperAccountRegisterUserRequest): Promise<DeveloperAccountInfo>;
    GetUserAccountInfoIfExists(request: Empty): Promise<GetUserAccountInfoResponse>;
}
export declare class DeveloperAccountClientProtobuf implements DeveloperAccountClient {
    private readonly rpc;
    constructor(rpc: Rpc);
    RegisterUser(request: DeveloperAccountRegisterUserRequest): Promise<DeveloperAccountInfo>;
    GetUserAccountInfoIfExists(request: Empty): Promise<GetUserAccountInfoResponse>;
